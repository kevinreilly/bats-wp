...
<div id="footer" class="clearfix">
	...
	<div id="footer-wrapper">
        ...
        <div class="grid col-300 scroll-top"><a href="#scroll-top" title="<?php esc_attr_e( 'scroll to top', 'responsive' ); ?>">Return to top <?php _e( '&uarr;', 'responsive' ); ?></a></div>
		...
		<div class="grid col-380 copyright">
			...
			?>
        	Identity and website by <a href="http://www.ozzodesign.com" target="_blank">Ozzo Design</a>.<br />
            Branding by <a href="http://www.primechuckcreative.com" target="_blank">Prime Chuck Creative</a>.<br />
		...
		<div class="grid col-220 fit powered">
			<strong>BATS Improv</strong><br />
            Fort Mason Center<br />
            2 Marina Blvd, Bldg B<br />
			San Francisco, California 94123<br />
			(415) 474-6776<br />
			<a href="mailto:bats@improv.org">bats@improv.org</a>
		</div>
		<!-- end .powered -->
