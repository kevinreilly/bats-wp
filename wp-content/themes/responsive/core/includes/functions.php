...
function responsive_widgets_init() {
	...
	register_sidebar( array(
						  'name'          => __( 'Home Content 1', 'responsive' ),
	...
	register_sidebar( array(
						  'name'          => __( 'Home Content 2', 'responsive' ),
	...
	register_sidebar( array(
						  'name'          => __( 'Home Content 3', 'responsive' ),
	...
	register_sidebar( array(
						  'name'          => __( 'Home Coming Soon 1', 'responsive' ),
						  'description'   => __( 'Area 9 - sidebar-home.php - Displays on the Home Page', 'responsive' ),
						  'id'            => 'home-widget-4',
	...
	register_sidebar( array(
						  'name'          => __( 'Home Coming Soon 2', 'responsive' ),
						  'description'   => __( 'Area 10 - sidebar-home.php - Displays on the Home Page', 'responsive' ),
						  'id'            => 'home-widget-5',
						  'before_title'  => '<div id="widget-title-fifth" class="widget-title-home"><h3>',
						  'after_title'   => '</h3></div>',
						  'before_widget' => '<div id="%1$s" class="widget-wrapper %2$s">',
						  'after_widget'  => '</div>'
					  ) );
	...
	register_sidebar( array(
						  'name'          => __( 'Home Coming Soon 3', 'responsive' ),
						  'description'   => __( 'Area 11 - sidebar-home.php - Displays on the Home Page', 'responsive' ),
						  'id'            => 'home-widget-6',
	...
	register_sidebar( array(
						  'name'          => __( 'Home Bottom', 'responsive' ),
						  'description'   => __( 'Area 11 - sidebar-home.php - Displays on the Home Page', 'responsive' ),
						  'id'            => 'home-widget-7',
						  'before_title'  => '<div id="widget-title-seven" class="widget-title-home"><h3>',
						  'after_title'   => '</h3></div>',
						  'before_widget' => '<div id="%1$s" class="widget-wrapper %2$s">',
						  'after_widget'  => '</div>'
					  ) );
	...
	register_sidebar( array(
						  'name'          => __( 'Home Featured Side', 'responsive' ),
						  'description'   => __( 'Area 12 - sidebar-home-featured-side.php', 'responsive' ),
						  'id'            => 'home-featured-side-widget',
						  //'before_title'  => '<div class="widget-title"><h3>',
						  //'after_title'   => '</h3></div>',
						  'before_widget' => '<div id="%1$s" class="grid %2$s"><div class="widget-wrapper">',
						  'after_widget'  => '</div></div>'
					  ) );

	register_sidebar( array(
						  'name'          => __( 'Home Side', 'responsive' ),
						  'description'   => __( 'Area 13 - sidebar-home-side.php', 'responsive' ),
						  'id'            => 'home-side-widget',
						  //'before_title'  => '<div class="widget-title"><h3>',
						  //'after_title'   => '</h3></div>',
						  'before_widget' => '<div id="%1$s" class="grid %2$s"><div class="widget-wrapper">',
	...
	register_sidebar( array(
						  'name'          => __( 'Shows Side', 'responsive' ),
						  'description'   => __( 'Area 14 - sidebar-shows-side.php', 'responsive' ),
						  'id'            => 'shows-side-widget',
						  //'before_title'  => '<div class="widget-title"><h3>',
						  //'after_title'   => '</h3></div>',
						  'before_widget' => '<div id="%1$s" class="grid %2$s"><div class="widget-wrapper">',
						  'after_widget'  => '</div></div>'
	...
	register_sidebar( array(
						  'name'          => __( 'Actor Side', 'responsive' ),
						  'description'   => __( 'Area 14 - sidebar-actor-side.php', 'responsive' ),
						  'id'            => 'actor-side-widget',
						  //'before_title'  => '<div class="widget-title"><h3>',
						  //'after_title'   => '</h3></div>',
						  'before_widget' => '<div id="%1$s" class="grid %2$s"><div class="widget-wrapper">',
						  'after_widget'  => '</div></div>'
	...
	register_sidebar( array(
						  'name'          => __( 'School', 'responsive' ),
						  'description'   => __( 'Area 14 - sidebar-school.php', 'responsive' ),
						  'id'            => 'school-widget',
						  //'before_title'  => '<div class="widget-title"><h3>',
						  //'after_title'   => '</h3></div>',
						  'before_widget' => '<div id="%1$s" class="grid %2$s"><div class="widget-wrapper">',
	...
	register_sidebar( array(
						  'name'          => __( 'About', 'responsive' ),
						  'description'   => __( 'Area 14 - sidebar-about.php', 'responsive' ),
						  'id'            => 'about-widget',
						  //'before_title'  => '<div class="widget-title"><h3>',
						  //'after_title'   => '</h3></div>',
						  'before_widget' => '<div id="%1$s" class="grid %2$s"><div class="widget-wrapper">',
	...
	register_sidebar( array(
						  'name'          => __( 'OTG', 'responsive' ),
						  'description'   => __( 'Area 14 - sidebar-otg.php', 'responsive' ),
						  'id'            => 'otg-widget',
						  //'before_title'  => '<div class="widget-title"><h3>',
						  //'after_title'   => '</h3></div>',
						  'before_widget' => '<div id="%1$s" class="grid %2$s"><div class="widget-wrapper">',
	...
	register_sidebar( array(
						  'name'          => __( 'Support', 'responsive' ),
						  'description'   => __( 'Area 14 - sidebar-support.php', 'responsive' ),
						  'id'            => 'support-widget',
						  //'before_title'  => '<div class="widget-title"><h3>',
						  //'after_title'   => '</h3></div>',
						  'before_widget' => '<div id="%1$s" class="grid %2$s"><div class="widget-wrapper">',
	...
	/* register_sidebar( array(
						  ...
						  'description'   => __( 'Area 14 - sidebar-gallery.php - Displays on the page after an image has been clicked in a Gallery', 'responsive' ),
						  'id'            => 'gallery-widget',
						  'before_title'  => '<div class="widget-title"><h3>',
						  'after_title'   => '</h3></div>',
						  'before_widget' => '<div id="%1$s" class="widget-wrapper %2$s">',
	...
	register_sidebar( array(
						  ...
						  'description'   => __( 'Area 15 - sidebar-colophon.php, 100% width Footer widgets', 'responsive' ),
						  'id'            => 'colophon-widget',
						  'before_title'  => '<div class="widget-title"><h3>',
						  'after_title'   => '</h3></div>',
	...
	register_sidebar( array(
						  ...
						  'description'   => __( 'Area 16 - sidebar-top.php - Displays on the right of the header', 'responsive' ),
						  'id'            => 'top-widget',
						  'before_title'  => '<div class="widget-title"><h3>',
						  'after_title'   => '</h3></div>',
	...
	register_sidebar( array(
						  ...
						  'description'   => __( 'Area 17 - sidebar-footer.php, use a maximum of 3 widgets', 'responsive' ),
						  'id'            => 'footer-widget',
						  'before_title'  => '<div class="widget-title"><h3>',
						  'after_title'   => '</h3></div>',
	...
	register_sidebar( array(
						  'name'          => __( 'Home Featured Left', 'responsive' ),
						  'description'   => __( 'Area 18 - sidebar-home-featured-left.php', 'responsive' ),
						  'id'            => 'home-featured-left-widget',
						  'before_title'  => '<div class="widget-title"><h3>',
						  'after_title'   => '</h3></div>',
						  'before_widget' => '<div id="%1$s" class="grid %2$s"><div class="widget-wrapper">',
						  'after_widget'  => '</div></div>'
	...
	register_sidebar( array(
						  'name'          => __( 'Home Featured Right', 'responsive' ),
						  'description'   => __( 'Area 18 - sidebar-home-featured-right.php', 'responsive' ),
						  'id'            => 'home-featured-right-widget',
						  'before_title'  => '<div class="widget-title"><h3>',
						  'after_title'   => '</h3></div>',
						  'before_widget' => '<div id="%1$s" class="grid %2$s"><div class="widget-wrapper">',
						  'after_widget'  => '</div></div>'
					  ...
					  register_sidebar( array(
						  'name'          => __( 'Home Set', 'responsive' ),
						  'description'   => __( 'Area 14 - sidebar-home-set.php', 'responsive' ),
						  'id'            => 'home-set-widget',
						  //'before_title'  => '<div class="widget-title"><h3>',
						  //'after_title'   => '</h3></div>',
						  'before_widget' => '<div id="%1$s" class="grid %2$s"><div class="widget-wrapper">',
					  ...
					  register_sidebar( array(
						  'name'          => __( 'Shows Set One', 'responsive' ),
						  'description'   => __( 'Area 14 - sidebar-shows-set-one.php', 'responsive' ),
						  'id'            => 'shows-set-one-widget',
						  //'before_title'  => '<div class="widget-title"><h3>',
						  //'after_title'   => '</h3></div>',
						  'before_widget' => '<div id="%1$s" class="grid %2$s"><div class="widget-wrapper">',
						  'after_widget'  => '</div></div>'
					  ...
					  register_sidebar( array(
						  'name'          => __( 'Shows Set Two', 'responsive' ),
						  'description'   => __( 'Area 14 - sidebar-shows-set-two.php', 'responsive' ),
						  'id'            => 'shows-set-two-widget',
						  //'before_title'  => '<div class="widget-title"><h3>',
						  //'after_title'   => '</h3></div>',
						  'before_widget' => '<div id="%1$s" class="grid %2$s"><div class="widget-wrapper">',
						  'after_widget'  => '</div></div>'
					  ...
					  register_sidebar( array(
						  'name'          => __( 'Shows Set Three', 'responsive' ),
						  'description'   => __( 'Area 14 - sidebar-shows-set-three.php', 'responsive' ),
						  'id'            => 'shows-set-three-widget',
						  //'before_title'  => '<div class="widget-title"><h3>',
						  //'after_title'   => '</h3></div>',
						  'before_widget' => '<div id="%1$s" class="grid %2$s"><div class="widget-wrapper">',
						  'after_widget'  => '</div></div>'
					  ...
					  register_sidebar( array(
						  'name'          => __( 'Shows Set Four', 'responsive' ),
						  'description'   => __( 'Area 14 - sidebar-shows-set-four.php', 'responsive' ),
						  'id'            => 'shows-set-four-widget',
						  //'before_title'  => '<div class="widget-title"><h3>',
						  //'after_title'   => '</h3></div>',
						  'before_widget' => '<div id="%1$s" class="grid %2$s"><div class="widget-wrapper">',
						  'after_widget'  => '</div></div>'
					  ...
					  register_sidebar( array(
						  'name'          => __( 'Shows Set Five', 'responsive' ),
						  'description'   => __( 'Area 14 - sidebar-shows-set-five.php', 'responsive' ),
						  'id'            => 'shows-set-five-widget',
						  //'before_title'  => '<div class="widget-title"><h3>',
						  //'after_title'   => '</h3></div>',
						  'before_widget' => '<div id="%1$s" class="grid %2$s"><div class="widget-wrapper">',
						  'after_widget'  => '</div></div>'
					  ...
					  register_sidebar( array(
						  'name'          => __( 'Shows Set Six', 'responsive' ),
						  'description'   => __( 'Area 14 - sidebar-shows-set-six.php', 'responsive' ),
						  'id'            => 'shows-set-six-widget',
						  //'before_title'  => '<div class="widget-title"><h3>',
						  //'after_title'   => '</h3></div>',
						  'before_widget' => '<div id="%1$s" class="grid %2$s"><div class="widget-wrapper">',
						  'after_widget'  => '</div></div>'
					  ...
					  register_sidebar( array(
						  'name'          => __( 'School Set One', 'responsive' ),
						  'description'   => __( 'Area 14 - sidebar-school-set-one.php', 'responsive' ),
						  'id'            => 'school-set-one-widget',
						  //'before_title'  => '<div class="widget-title"><h3>',
						  //'after_title'   => '</h3></div>',
						  'before_widget' => '<div id="%1$s" class="grid %2$s"><div class="widget-wrapper">',
						  'after_widget'  => '</div></div>'
					  ...
					  register_sidebar( array(
						  'name'          => __( 'School Set Two', 'responsive' ),
						  'description'   => __( 'Area 14 - sidebar-school-set-two.php', 'responsive' ),
						  'id'            => 'school-set-two-widget',
						  //'before_title'  => '<div class="widget-title"><h3>',
						  //'after_title'   => '</h3></div>',
						  'before_widget' => '<div id="%1$s" class="grid %2$s"><div class="widget-wrapper">',
						  'after_widget'  => '</div></div>'
					  ...
					  register_sidebar( array(
						  'name'          => __( 'School Set Three', 'responsive' ),
						  'description'   => __( 'Area 14 - sidebar-school-set-three.php', 'responsive' ),
						  'id'            => 'school-set-three-widget',
						  //'before_title'  => '<div class="widget-title"><h3>',
						  //'after_title'   => '</h3></div>',
						  'before_widget' => '<div id="%1$s" class="grid %2$s"><div class="widget-wrapper">',
						  'after_widget'  => '</div></div>'
					  ...
					  register_sidebar( array(
						  'name'          => __( 'School Set Four', 'responsive' ),
						  'description'   => __( 'Area 14 - sidebar-school-set-four.php', 'responsive' ),
						  'id'            => 'school-set-four-widget',
						  //'before_title'  => '<div class="widget-title"><h3>',
						  //'after_title'   => '</h3></div>',
						  'before_widget' => '<div id="%1$s" class="grid %2$s"><div class="widget-wrapper">',
						  'after_widget'  => '</div></div>'
					  ...
					  register_sidebar( array(
						  'name'          => __( 'School Set Five', 'responsive' ),
						  'description'   => __( 'Area 14 - sidebar-school-set-five.php', 'responsive' ),
						  'id'            => 'school-set-five-widget',
						  //'before_title'  => '<div class="widget-title"><h3>',
						  //'after_title'   => '</h3></div>',
						  'before_widget' => '<div id="%1$s" class="grid %2$s"><div class="widget-wrapper">',
						  'after_widget'  => '</div></div>'
					  ...
					  register_sidebar( array(
						  'name'          => __( 'OTG Set One', 'responsive' ),
						  'description'   => __( 'Area 14 - sidebar-otg-set-one.php', 'responsive' ),
						  'id'            => 'otg-set-one-widget',
						  //'before_title'  => '<div class="widget-title"><h3>',
						  //'after_title'   => '</h3></div>',
						  'before_widget' => '<div id="%1$s" class="grid %2$s"><div class="widget-wrapper">',
						  'after_widget'  => '</div></div>'
					  ...
					  register_sidebar( array(
						  'name'          => __( 'OTG Set Two', 'responsive' ),
						  'description'   => __( 'Area 14 - sidebar-otg-set-two.php', 'responsive' ),
						  'id'            => 'otg-set-two-widget',
						  //'before_title'  => '<div class="widget-title"><h3>',
						  //'after_title'   => '</h3></div>',
						  'before_widget' => '<div id="%1$s" class="grid %2$s"><div class="widget-wrapper">',
						  'after_widget'  => '</div></div>'
					  ...
					  register_sidebar( array(
						  'name'          => __( 'About Set One', 'responsive' ),
						  'description'   => __( 'Area 14 - sidebar-about-set-one.php', 'responsive' ),
						  'id'            => 'about-set-one-widget',
						  //'before_title'  => '<div class="widget-title"><h3>',
						  //'after_title'   => '</h3></div>',
						  'before_widget' => '<div id="%1$s" class="grid %2$s"><div class="widget-wrapper">',
						  'after_widget'  => '</div></div>'
					  ...
					  register_sidebar( array(
						  'name'          => __( 'About Set Two', 'responsive' ),
						  'description'   => __( 'Area 14 - sidebar-about-set-two.php', 'responsive' ),
						  'id'            => 'about-set-two-widget',
						  //'before_title'  => '<div class="widget-title"><h3>',
						  //'after_title'   => '</h3></div>',
						  'before_widget' => '<div id="%1$s" class="grid %2$s"><div class="widget-wrapper">',
						  'after_widget'  => '</div></div>'
					  ...
					  register_sidebar( array(
						  'name'          => __( 'About Set Three', 'responsive' ),
						  'description'   => __( 'Area 14 - sidebar-about-set-three.php', 'responsive' ),
						  'id'            => 'about-set-three-widget',
						  //'before_title'  => '<div class="widget-title"><h3>',
						  //'after_title'   => '</h3></div>',
						  'before_widget' => '<div id="%1$s" class="grid %2$s"><div class="widget-wrapper">',
						  'after_widget'  => '</div></div>'
					  ...
					  register_sidebar( array(
						  'name'          => __( 'Support Set One', 'responsive' ),
						  'description'   => __( 'Area 14 - sidebar-support-set-one.php', 'responsive' ),
						  'id'            => 'support-set-one-widget',
						  //'before_title'  => '<div class="widget-title"><h3>',
						  //'after_title'   => '</h3></div>',
						  'before_widget' => '<div id="%1$s" class="grid %2$s"><div class="widget-wrapper">',
						  'after_widget'  => '</div></div>'
					  ...
					  register_sidebar( array(
						  'name'          => __( 'Support Set Two', 'responsive' ),
						  'description'   => __( 'Area 14 - sidebar-support-set-two.php', 'responsive' ),
						  'id'            => 'support-set-two-widget',
						  //'before_title'  => '<div class="widget-title"><h3>',
						  //'after_title'   => '</h3></div>',
						  'before_widget' => '<div id="%1$s" class="grid %2$s"><div class="widget-wrapper">',
						  'after_widget'  => '</div></div>'
