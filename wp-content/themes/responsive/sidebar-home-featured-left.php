...
/**
 * Home Featured Left Template
 *
 *
 * @file           sidebar-home-featured-left.php
 * @package        Responsive
 * @author         Emil Uzelac
 * @copyright      2003 - 2013 ThemeID
 * @license        license.txt
 * @version        Release: 1.0
 * @filesource     wp-content/themes/responsive/sidebar-home-featured-side.php
...
<?php responsive_widgets_before(); // above widgets container hook ?>
	<div id="widgets">
		...
		<?php if( !dynamic_sidebar( 'home-featured-left' ) ) : ?>
		...
		<?php endif; //end of home-featured-left ?>
