...
/**
 * Foundation 1 Page Template
 *
Template Name:  Foundation 1
 *
...
<div id="content" class="grid col-700">
	...
	?>
    <div class="banner"><h3>Upcoming Foundation 1 Classes</h3></div>
		...
		<?php while ( $the_query->have_posts() ) : $the_query->the_post(); ?>
            ...
            <div class="school-class">
            	<div class="class-details">
                    ...
                    <div style="float:left;"><?php echo $class_details; ?></div>
