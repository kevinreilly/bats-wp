...
/**
 * Summer Sessions Page Template
 *
Template Name:  Summer Sessions
 *
 * @file           summersessions-page.php
 * @package        Responsive
 * @author         Emil Uzelac
 * @copyright      2003 - 2011 ThemeID
 * @license        license.txt
 * @version        Release: 1.0
 * @filesource     wp-content/themes/responsive/summersessions-page.php
...
<div id="content" class="grid col-700">
	...
	?>
	<div class="banner"><h3>Upcoming Summer Sessions</h3></div>
